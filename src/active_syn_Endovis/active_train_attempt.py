# -*- coding: utf-8 -*-
"""
Created on Mon Mar  1 09:02:07 2021
...
def active_train_attempt(path_workspace, folder_workspace):
    ...
    return vali_evaluation_result, test_evaluation_result