...
class DeepLab(object):
  def __init__(self,sess,
    ...
    self.learning_rate = learning_rate # 0.0005  original
    self.beta1=0.9
    self.seed=23
...
#             scope=self.model_name)
        ...
        _,end_points = mobilenet_v1(h,
                 num_classes=0,
                 dropout_keep_prob= dropout_keep_prob,  #[HP] dropout rate here
                 is_training=self.is_train,
                 min_depth=8,
    ...
    h = end_points[end_points_pointwise]   # [HP] change the size of CNN, this should co-work with a setting in mobilenet
