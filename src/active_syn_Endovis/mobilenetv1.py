...
# [hyper paramters]-------------------------------------------------------
weights_regu = 0.0 # seems not useful
biases_regu = 0.0 # seems not useful
weight_decay = 0.00004 # 0.00004 original, not tested yet
end_points_pointwise = 'Conv2d_13_pointwise' # this should work together with the same parameter in 'model.py'
# [hyper paramters]-------------------------------------------------------
...
def mobilenet_v1_base(inputs,
                      final_endpoint = end_points_pointwise,
                      min_depth=8,
