...
class active_syn_generator:
    ...
    def generate_syn_img(self, image, label, dilation = 60, syn1 = 10, syn2 = 10, multi_gen = 2, multi_gen_same = False, flip=0.5, shrink_factor=0.9, 
                         ...
                         border_center=(120,120), radius=115, ksize=(1,3), sig_x=2,
        ...
        for iteration in range(0, syn1):
            ...
            for iteration in range(0, multi_gen):
                ...
                self.set_bound_and_blur(border_type = 'circle', border_center = (rand_from_range(border_center[0][0], border_center[0][1]), rand_from_range(border_center[1][0], border_center[1][1])),
    ...
    def shrink_tool(self, factor, show_img = False):
        ...
        if factor < 1:
            ...
            tool_shrinked = cv2.resize(self.tool['img'], shape_sk)
            ...
            tool_map_shrinked = cv2.resize(tool_map_int, shape_sk)
    ...
    def set_bound_and_blur(self, border_type = 'circle', border_center = (500, 500), radius = 500, border_rect = (8,8,73,73), border_color = [[18.9, 5.5], [17.7, 5.3], [24.6, 7.1]], ksize = 3, sig_x = 27,  show_img = False):
